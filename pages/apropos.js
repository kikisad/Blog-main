      ...
      >
        <div className="">
          <motion.div variants={fadeInUp} key="modal-aporpos-1" class="ml-10 ">
            <h2 className="sm:text-5xl text-4xl md:text-6xl pt-32 font-bold tracking-tighter leading-tight">
              À propos de moi
            </h2>
          ...
          <div class="flex flex-row items-center">
            ...
            <div class="w-full sm:w-2/5 pl-5 pr-5">
              ...
              <h3 className="text-xs sm:text-sm pt-1 text-gray-400">
                <a
                  href="mailto:killiancartignies@gmail.com"
              ...
              <h3 className="text-xs sm:text-sm pt-1 text-gray-400">
                Allons boire un café, si tu passe par{' '}
                <a
          ...
          <div class="ml-10 mr-10 mt-10">
            <h3 className="text-sm ">
              <h1 className="text-base mt-2 font-bold tracking-tighter leading-tight">
                🇫🇷🇫🇷 Je suis étudiant entrepreneur et freelance UX & UI designer
                ⬇️ <br />
              </h1>
              <p>
                <br />
              ...
              <p>
                ...
                <br />
                <br />
                Je vis dans le sud de la France, dans la région de Toulon, au
          ...
          <motion.div
            variants={stagger}
            key="modal-aporpos-2"
            class="w-full mw-auto mb-20 lg:mt-10 lg:mb-20 sm:mt-10  mx-auto "
          >
            <div class="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 sm:gap-x-6 px-12 sm:px-10 sm:gap-y-14 gap-x-5 gap-y-5 mt-10 items-center text-center	 ">
              <motion.div variants={fadeInUp} key="modal-aporpos-3">
                <Image
                  ...
                  quality="100"
                  src={
                    '/static/images/Icon-Apropos-De-moi-design-blog-3D-Elastique.png'
                  }
                />
              ...
              <motion.div variants={fadeInUp} key="modal-aporpos-4">
                <Image
                  ...
                  quality="100"
                  src={
                    '/static/images/Icon-Apropos-De-moi-design-blog-3D-message-Vert.png'
                  }
                />
                <h2 className="text-base mt-5 font-bold tracking-tighter leading-tight">
                  Entrepreneurs
              ...
              <motion.div variants={fadeInUp} key="modal-aporpos-6">
                <Image
                  ...
                  quality="100"
                  src={
                    '/static/images/Icon-Apropos-De-moi-design-blog-3D-bousole.png'
                  }
                />
                <h2 className="text-base mt-5 font-bold tracking-tighter leading-tight">
                  Ma philosophie
